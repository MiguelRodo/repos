...
- [Overview](#overview)
  - [Customizations](#customizations)
    - [`repos.list`](#reposlist)
      - [Global Flags in repos.list](#global-flags-in-reposlist)
      - [Per-Line Flags](#per-line-flags)
    - [`repos setup`](#repos-setup)
- [Installation](#installation)
  - [Ubuntu/Debian](#ubuntu-debian)
    - [Option 1: Local Installation (No sudo required)](#option-1-local-installation-no-sudo-required)
    - [Option 2: Install from APT Repository (Recommended)](#option-2-install-from-apt-repository-recommended)
    - [Option 3: System-wide Installation from Release .deb (Requires sudo)](#option-3-system-wide-installation-from-release-deb-requires-sudo)
...
- [Usage](#usage)
  ...
  - [repos setup](#repos-setup-1)
  - [repos run](#repos-run)
  - [Advanced Features](#advanced-features)
  - [Repository Layout](#repository-layout)
  - [repos.list Format](#reposlist-format)
  - [Running Pipelines](#running-pipelines)
- [Configuration](#configuration)
  - [GitHub Authentication](#github-authentication)
  - [VS Code Workspace](#vs-code-workspace)
- [Examples](#examples)
  - [Example 1: Clone multiple repositories](#example-1-clone-multiple-repositories)
  - [Example 2: Work on multiple branches](#example-2-work-on-multiple-branches)
  - [Example 3: Mixed repositories and worktrees](#example-3-mixed-repositories-and-worktrees)
